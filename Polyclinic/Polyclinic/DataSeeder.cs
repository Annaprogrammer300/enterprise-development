...
public static class DataSeeder
{
    ...
    [
        new Patient { PassportNumber="P001", FullName="Иванов Иван",     Gender=Gender.Male,
        ...
        new Patient { PassportNumber="P002", FullName="Петров Петр",     Gender=Gender.Male,
        ...
        new Patient { PassportNumber="P003", FullName="Сидорова Анна",   Gender=Gender.Female,
        ...
        new Patient { PassportNumber="P004", FullName="Кузнецов Сергей", Gender=Gender.Male,
        ...
        new Patient { PassportNumber="P005", FullName="Смирнова Мария",  Gender=Gender.Female,
        ...
        new Patient { PassportNumber="P006", FullName="Орлов Дмитрий",   Gender=Gender.Male,
        ...
        new Patient { PassportNumber="P007", FullName="Васильева Ирина", Gender=Gender.Female,
        ...
        new Patient { PassportNumber="P008", FullName="Морозов Алексей", Gender=Gender.Male,
        ...
        new Patient { PassportNumber="P009", FullName="Николаева Елена", Gender=Gender.Female,
        ...
        new Patient { PassportNumber="P010", FullName="Зайцев Павел",   Gender=Gender.Male,
    ...
    static DataSeeder()
    {
        ...
        _appointments =
        [
            new () { Patient=_patients[0],  Doctor=_doctors[0], DateTime=new DateTime(2025, 8, 15, 14, 50, 0, DateTimeKind.Utc), RoomNumber=101, IsRepeat=false },
            new () { Patient=_patients[1],  Doctor=_doctors[1], DateTime=new DateTime(2025, 6, 30, 12, 30, 0, DateTimeKind.Utc), RoomNumber=102, IsRepeat=true  },
            new () { Patient=_patients[2],  Doctor=_doctors[2], DateTime=new DateTime(2025, 10, 30, 12, 0, 0, DateTimeKind.Utc), RoomNumber=103, IsRepeat=false },
            new () { Patient=_patients[3],  Doctor=_doctors[3], DateTime=new DateTime(2025, 6, 7, 11, 30, 0, DateTimeKind.Utc), RoomNumber=104, IsRepeat=true  },
            new () { Patient=_patients[4],  Doctor=_doctors[4], DateTime=new DateTime(2025, 6, 10, 12, 20, 0, DateTimeKind.Utc), RoomNumber=105, IsRepeat=true  },
            new () { Patient=_patients[5],  Doctor=_doctors[4], DateTime=new DateTime(2025, 7, 24, 10, 0, 0, DateTimeKind.Utc), RoomNumber=105, IsRepeat=false },
            new () { Patient=_patients[5],  Doctor=_doctors[0], DateTime=new DateTime(2025, 6, 1, 12, 30, 0, DateTimeKind.Utc), RoomNumber=101, IsRepeat=true  },
            new () { Patient=_patients[6],  Doctor=_doctors[2], DateTime=new DateTime(2025, 3, 30, 14, 30, 0, DateTimeKind.Utc), RoomNumber=103, IsRepeat=false },
            new () { Patient=_patients[7],  Doctor=_doctors[7], DateTime=new DateTime(2025, 6, 17, 12, 0, 0, DateTimeKind.Utc), RoomNumber=108, IsRepeat=true  },
            new () { Patient=_patients[8],  Doctor=_doctors[8], DateTime=new DateTime(2025, 8, 8, 16, 30, 0, DateTimeKind.Utc), RoomNumber=108, IsRepeat=false },
            new () { Patient=_patients[9],  Doctor=_doctors[9], DateTime=new DateTime(2025, 9, 27, 12, 24, 0, DateTimeKind.Utc), RoomNumber=109, IsRepeat=true  }
        ];
    }
