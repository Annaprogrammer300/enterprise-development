...
public static class DataSeeder
{
    ...
    static DataSeeder()
    {
        ...
        _appointments =
        [
            new () { Id = 1,  Patient=_patients[0],  Doctor=_doctors[0], DateTime=new DateTime(2025, 8, 15, 14, 50,0),  RoomNumber=101, IsRepeat=false },
            new () { Id = 2,  Patient=_patients[1],  Doctor=_doctors[1], DateTime=new DateTime(2025, 6, 30, 12, 30,0),  RoomNumber=102, IsRepeat=true  },
            new () { Id = 3,  Patient=_patients[2],  Doctor=_doctors[2], DateTime=new DateTime(2025, 10, 30, 12, 00,0), RoomNumber=103, IsRepeat=false },
            new () { Id = 4,  Patient=_patients[3],  Doctor=_doctors[3], DateTime=new DateTime(2025, 6, 7, 11, 30,0),   RoomNumber=104, IsRepeat=true  },
            new () { Id = 5,  Patient=_patients[4],  Doctor=_doctors[4], DateTime=new DateTime(2025, 6, 10, 12, 20,0),  RoomNumber=105, IsRepeat=true  },
            new () { Id = 6,  Patient=_patients[5],  Doctor=_doctors[4], DateTime=new DateTime(2025, 7, 24, 10, 00,0),  RoomNumber=105, IsRepeat=false },
            new () { Id = 7,  Patient=_patients[5],  Doctor=_doctors[0], DateTime=new DateTime(2025, 6, 1, 12, 30,0),   RoomNumber=101, IsRepeat=true  },
            new () { Id = 8,  Patient=_patients[6],  Doctor=_doctors[2], DateTime=new DateTime(2025, 3, 30, 14, 30,0),  RoomNumber=103, IsRepeat=false },
            new () { Id = 9,  Patient=_patients[7],  Doctor=_doctors[7], DateTime=new DateTime(2025, 6, 17, 12, 00,0),  RoomNumber=108, IsRepeat=true  },
            new () { Id = 10, Patient=_patients[8],  Doctor=_doctors[8], DateTime=new DateTime(2025, 8, 8, 16, 30,0),   RoomNumber=108, IsRepeat=false },
            new () { Id = 11, Patient=_patients[9],  Doctor=_doctors[9], DateTime=new DateTime(2025, 9, 27, 12, 24,0),  RoomNumber=109, IsRepeat=true  }
        ];
    }
